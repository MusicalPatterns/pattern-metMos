...
const GOLDEN_MEANTONE_PRESET_RATIO: Fraction = as.Fraction([ as.Numerator(1), as.Denominator(3) ])
...
const WILSON_PEPPER_FIFTH_PRESET_RATIO: Fraction = as.Fraction([ as.Numerator(3), as.Denominator(7) ])

const ARGENT_TEMPERAMENT_PRESET_ITERATIONS: Cardinal = as.Cardinal(5)
const ARGENT_TEMPERAMENT_PRESET_RATIO: Fraction = as.Fraction([ as.Numerator(1), as.Denominator(1) ])
const ARGENT_TEMPERAMENT_PRESET_METAL: Ordinal = as.Ordinal(2)
const ARGENT_TEMPERAMENT_PRESET_ISOTOPE: Ordinal = as.Ordinal(1)

const IMAGINARY_PRESET_RATIO: Fraction = as.Fraction([ as.Numerator(1), as.Denominator(1) ])
...
const FIBONACCI_PRESET_RATIO: Fraction = as.Fraction([ as.Numerator(1), as.Denominator(3) ])
...
const LUCAS_PRESET_RATIO: Fraction = as.Fraction([ as.Numerator(1), as.Denominator(3) ])
const LUCAS_PRESET_LEAN: Lean = Lean.CHILDWARD

const HANSON_PRESET_ITERATIONS: Cardinal = as.Cardinal(5)
const HANSON_PRESET_RATIO: Fraction = as.Fraction([ as.Numerator(3), as.Denominator(11) ])
