...
describe('introduction counts - given a target level and list of means and/or isotopes, gives the count of unique generators introduced per level', (): void => {
    const testLevelIndex: Ordinal<Tree> = as.Ordinal<Tree>(7)

    it('gives the correct results for the golden mean', (): void => {
    ...
    describe('beyond golden means and their isotopes, individually', (): void => {
        it('gives the correct results for the silver mean and its isotope', (): void => {
        ...
        it('gives the correct results for the bronze mean and its isotopes', (): void => {
        ...
        it('gives the correct results for the 4th metallic mean and its isotopes', (): void => {
    ...
    describe('beyond golden means and their isotopes, together', (): void => {
        it('gives the correct results for the silver mean and its isotope', (): void => {
