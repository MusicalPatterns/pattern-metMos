...
const MET_MOS_INITIAL_RATIO: Fraction = asFraction(1, 1)
...
const GOLDEN_MEANTONE_PRESET_RATIO: Fraction = asFraction(1, 3)
...
const FIBONACCI_PRESET_RATIO: Fraction = asFraction(1, 3)
...
const LUCAS_PRESET_RATIO: Fraction = asFraction(1, 3)
const LUCAS_PRESET_LEAN: Lean = Lean.CHILDWARD

const HANSON_PRESET_ITERATIONS: Cardinal = as.Cardinal(5)
const HANSON_PRESET_RATIO: Fraction = asFraction(3, 11)
